...
def main(pArgs):
    ...
    regAddr  = [0x01c, 0x020, 0x024, 0x028, 0x02c, 0x030, 0x034, 0x038, 0x0ec, 0xa8, 0xe8]
    regDataA = [ 0x00,  0xc8,  0x55,  0x05,  0x88,  0x0a,  0x00,  0x00,  0x00, 0x10, 0x07]
    ...
    regDataD = [ 0x55,  0x55,  0x55,  0x00,  0x0a,  0x00,  0x00,  0x00,  0x07, 0x94, 0x00]
