...
def main():
    ...
    #else includes the case of if runType == 't':
    ...
    #PedData.AnalyzeBaseline(plot_dir, runName,chans_to_plot = ["channel076","channel077","channel078","channel079"] ) #example specifying certain channels to analyze
    ...
    #chs_to_plot = ["channel076","channel077","channel078","channel079"]
